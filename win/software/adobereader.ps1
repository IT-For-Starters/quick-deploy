...
#### Changable Variables!
$scriptLocation = "C:\temp\quick-deploy\software\adobe-reader"

$installerUrl = "https://ardownload2.adobe.com/pub/adobe/acrobat/win/AcrobatDC/2400520320/AcroRdrDCx642400520320_MUI.exe";
$installerName = "adobe_installer.exe";

$installerArguments = "/sAll /msi /norestart /quiet ALLUSERS=1 EULA_ACCEPT=YES";
$installMSI = $false;
